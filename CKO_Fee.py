...
# ==========================================
# --- NEW: Vertical Scheme Pivot Table   ---
# ==========================================
st.markdown("**Cost % by Vertical, Scheme, and Card Type**")

# Combine and standardize casing for Visa and Mastercard
vmc_df = pd.concat([visa_df, mc_df])
vmc_df['Payment Method'] = vmc_df['Payment Method'].str.upper()

# Ensure we only have Credit and Debit for the columns
...
if not pivot_base.empty:
    ...
    # Pivot to get Channel on Y, Scheme/Card Type on X
